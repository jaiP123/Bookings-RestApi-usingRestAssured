...
public class UpdateBooking extends BaseTest {
	...
	public void updateBooking(){
		...
		// Use PUT request to /booking/{id} and check that the response has HTTP status code 200

		//Sending the PUT request for a specific booking id and receiving the response after updating the details
